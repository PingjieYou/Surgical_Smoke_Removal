...
class AtmosphereCycleGANModel(BaseModel):
    @staticmethod
    ...
    def backward_G(self):
        ...
        # mse
        self.loss_mse = self.criterionEq(self.dehaze_image_g, self.clear_image) * 10.

        # combined loss and calculate gradients
        self.loss_G = self.loss_G_A + self.loss_G_B + self.loss_cycle_A + self.loss_cycle_B + self.loss_idt_A + self.loss_idt_B + self.loss_eq + self.loss_mse
